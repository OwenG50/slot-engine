...
game.configureOptimization({
  gameModes: {
    ...
    bonusHunt: {
      ...
      scaling: new OptimizationScaling([
        // ── Base game ──────────────────────────────────────────────────────
        { criteria: "basegame", scaleFactor: 1.6,  winRange: [0.01,  1],     probability: 1 },
        { criteria: "basegame", scaleFactor: 1.4,  winRange: [1,     2],     probability: 1 },
        { criteria: "basegame", scaleFactor: 1.2,  winRange: [2,     5],     probability: 1 },
        { criteria: "basegame", scaleFactor: 1.0,  winRange: [5,     10],    probability: 1 },
        { criteria: "basegame", scaleFactor: 0.85, winRange: [10,    20],    probability: 1 },
        { criteria: "basegame", scaleFactor: 0.7,  winRange: [20,    50],    probability: 1 },
        { criteria: "basegame", scaleFactor: 0.55, winRange: [50,    100],   probability: 1 },
        { criteria: "basegame", scaleFactor: 0.4,  winRange: [100,   200],   probability: 1 },
        { criteria: "basegame", scaleFactor: 0.3,  winRange: [200,   500],   probability: 1 },
        { criteria: "basegame", scaleFactor: 0.2,  winRange: [500,   1000],  probability: 1 },
        { criteria: "basegame", scaleFactor: 0.15, winRange: [1000,  2000],  probability: 1 },
        { criteria: "basegame", scaleFactor: 0.1,  winRange: [2000,  5000],  probability: 1 },
        { criteria: "basegame", scaleFactor: 0.07, winRange: [5000,  10000], probability: 1 },
        { criteria: "basegame", scaleFactor: 0.05, winRange: [10000, 15000], probability: 1 },
        { criteria: "basegame", scaleFactor: 1,    winRange: [15000, 15000], probability: 1 },
        // ── Free spins ─────────────────────────────────────────────────────
        { criteria: "freespins", scaleFactor: 0.5,  winRange: [0.01,  1],     probability: 1 },
        { criteria: "freespins", scaleFactor: 0.7,  winRange: [1,     2],     probability: 1 },
        ...
        { criteria: "freespins", scaleFactor: 1.15, winRange: [100,   200],   probability: 1 },
        { criteria: "freespins", scaleFactor: 0.95, winRange: [200,   500],   probability: 1 },
        { criteria: "freespins", scaleFactor: 0.75, winRange: [500,   1000],  probability: 1 },
        { criteria: "freespins", scaleFactor: 0.55, winRange: [1000,  2000],  probability: 1 },
        { criteria: "freespins", scaleFactor: 0.35, winRange: [2000,  5000],  probability: 1 },
        { criteria: "freespins", scaleFactor: 0.2,  winRange: [5000,  10000], probability: 1 },
        { criteria: "freespins", scaleFactor: 0.12, winRange: [10000, 15000], probability: 1 },
        { criteria: "freespins", scaleFactor: 1,    winRange: [15000, 15000], probability: 1 },
        ...
        { criteria: "superfreespins", scaleFactor: 1.55, winRange: [100,   200],   probability: 1 },
        { criteria: "superfreespins", scaleFactor: 1.45, winRange: [200,   500],   probability: 1 },
        { criteria: "superfreespins", scaleFactor: 1.2,  winRange: [500,   1000],  probability: 1 },
        { criteria: "superfreespins", scaleFactor: 0.9,  winRange: [1000,  2000],  probability: 1 },
        { criteria: "superfreespins", scaleFactor: 0.6,  winRange: [2000,  5000],  probability: 1 },
        { criteria: "superfreespins", scaleFactor: 0.4,  winRange: [5000,  10000], probability: 1 },
        { criteria: "superfreespins", scaleFactor: 0.22, winRange: [10000, 15000], probability: 1 },
        { criteria: "superfreespins", scaleFactor: 1,    winRange: [15000, 15000], probability: 1 },
