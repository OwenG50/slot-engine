  ...
  gameModes: {
    base: {
      ...
      scaling: new OptimizationScaling([
        ...
        { criteria: "basegame", scaleFactor: 180.0, winRange: [1, 2], probability: 1 },
        ...
        { criteria: "basegame", scaleFactor: 0.055, winRange: [50, 75], probability: 1 },
        { criteria: "basegame", scaleFactor: 0.045, winRange: [75, 100], probability: 1 },
        { criteria: "basegame", scaleFactor: 0.00045, winRange: [100, 125], probability: 1 },
        { criteria: "basegame", scaleFactor: 0.0003, winRange: [125, 150], probability: 1 },
        { criteria: "basegame", scaleFactor: 0.00022, winRange: [150, 175], probability: 1 },
        { criteria: "basegame", scaleFactor: 0.00016, winRange: [175, 200], probability: 1 },
        { criteria: "basegame", scaleFactor: 0.00165, winRange: [200, 300], probability: 1 },
        { criteria: "basegame", scaleFactor: 0.00115, winRange: [300, 400], probability: 1 },
        { criteria: "basegame", scaleFactor: 0.0009, winRange: [400, 500], probability: 1 },
        { criteria: "basegame", scaleFactor: 0.12, winRange: [500, 1000], probability: 1 },
        ...
        { criteria: "freespins", scaleFactor: 0.15, winRange: [2, 5], probability: 1 },
        { criteria: "freespins", scaleFactor: 0.25, winRange: [5, 10], probability: 1 },
        { criteria: "freespins", scaleFactor: 0.35, winRange: [10, 20], probability: 1 },
        { criteria: "freespins", scaleFactor: 8.0, winRange: [20, 50], probability: 1 },
        { criteria: "freespins", scaleFactor: 3.2, winRange: [50, 100], probability: 1 },
        { criteria: "freespins", scaleFactor: 0.9, winRange: [100, 200], probability: 1 },
        { criteria: "freespins", scaleFactor: 2.0, winRange: [200, 500], probability: 1 },
        ...
        { criteria: "freespins", scaleFactor: 0.45, winRange: [5000, 10000], probability: 1 },
        { criteria: "freespins", scaleFactor: 0.2, winRange: [10000, 15000], probability: 1 },
        { criteria: "freespins", scaleFactor: 1, winRange: [15000, 15000], probability: 1 },
        { criteria: "superfreespins", scaleFactor: 0.5, winRange: [0.01, 20], probability: 1 },
        { criteria: "superfreespins", scaleFactor: 0.15, winRange: [20, 50], probability: 1 },
        { criteria: "superfreespins", scaleFactor: 2.8, winRange: [50, 100], probability: 1 },
        { criteria: "superfreespins", scaleFactor: 1.3, winRange: [100, 200], probability: 1 },
        { criteria: "superfreespins", scaleFactor: 1.2, winRange: [200, 500], probability: 1 },
        { criteria: "superfreespins", scaleFactor: 2.7, winRange: [500, 1000], probability: 1 },
        { criteria: "superfreespins", scaleFactor: 1.6, winRange: [1000, 2000], probability: 1 },
        { criteria: "superfreespins", scaleFactor: 0.9, winRange: [2000, 5000], probability: 1 },
        ...
        { criteria: "hiddenfreespins", scaleFactor: 0.4, winRange: [0.01, 20], probability: 1 },
        { criteria: "hiddenfreespins", scaleFactor: 0.9, winRange: [20, 50], probability: 1 },
        { criteria: "hiddenfreespins", scaleFactor: 2.2, winRange: [50, 100], probability: 1 },
        { criteria: "hiddenfreespins", scaleFactor: 1.0, winRange: [100, 200], probability: 1 },
        { criteria: "hiddenfreespins", scaleFactor: 1.0, winRange: [200, 500], probability: 1 },
        ...
        { criteria: "hiddenfreespins", scaleFactor: 1.0, winRange: [2000, 5000], probability: 1 },
    ...
    bonusHunt: {
      ...
      scaling: new OptimizationScaling([
        ...
        { criteria: "freespins", scaleFactor: 0.25, winRange: [1, 2], probability: 1 },
        { criteria: "freespins", scaleFactor: 0.1, winRange: [2, 5], probability: 1 },
        { criteria: "freespins", scaleFactor: 0.15, winRange: [5, 10], probability: 1 },
        { criteria: "freespins", scaleFactor: 0.4, winRange: [10, 20], probability: 1 },
        { criteria: "freespins", scaleFactor: 7.0, winRange: [20, 50], probability: 1 },
        { criteria: "freespins", scaleFactor: 3.0, winRange: [50, 100], probability: 1 },
        ...
        { criteria: "freespins", scaleFactor: 1.0, winRange: [500, 1000], probability: 1 },
        { criteria: "freespins", scaleFactor: 1.2, winRange: [1000, 2000], probability: 1 },
        ...
        { criteria: "superfreespins", scaleFactor: 0.3, winRange: [20, 50], probability: 1 },
        { criteria: "superfreespins", scaleFactor: 5.5, winRange: [50, 100], probability: 1 },
        { criteria: "superfreespins", scaleFactor: 1.0, winRange: [100, 200], probability: 1 },
        { criteria: "superfreespins", scaleFactor: 1.3, winRange: [200, 500], probability: 1 },
        { criteria: "superfreespins", scaleFactor: 2.0, winRange: [500, 1000], probability: 1 },
        ...
        { criteria: "hiddenfreespins", scaleFactor: 1.0, winRange: [50, 100], probability: 1 },
        { criteria: "hiddenfreespins", scaleFactor: 1.0, winRange: [100, 200], probability: 1 },
        { criteria: "hiddenfreespins", scaleFactor: 1.3, winRange: [200, 500], probability: 1 },
        { criteria: "hiddenfreespins", scaleFactor: 6.0, winRange: [500, 1000], probability: 1 },
    ...
    bonusFeature: {
      ...
      scaling: new OptimizationScaling([
        ...
        { criteria: "freespins", scaleFactor: 3.0, winRange: [1, 2], probability: 1 },
        ...
        { criteria: "freespins", scaleFactor: 0.022, winRange: [20, 50], probability: 1 },
        { criteria: "freespins", scaleFactor: 1.1, winRange: [50, 100], probability: 1 },
        { criteria: "freespins", scaleFactor: 0.95, winRange: [100, 200], probability: 1 },
        { criteria: "freespins", scaleFactor: 0.5, winRange: [200, 500], probability: 1 },
        { criteria: "freespins", scaleFactor: 0.18, winRange: [500, 1000], probability: 1 },
        { criteria: "freespins", scaleFactor: 0.1, winRange: [1000, 2000], probability: 1 },
        { criteria: "freespins", scaleFactor: 0.2, winRange: [2000, 5000], probability: 1 },
        { criteria: "freespins", scaleFactor: 0.12, winRange: [5000, 10000], probability: 1 },
        { criteria: "freespins", scaleFactor: 0.08, winRange: [10000, 15000], probability: 1 },
        { criteria: "freespins", scaleFactor: 1, winRange: [15000, 15000], probability: 1 },
      ]),
      parameters: new OptimizationParameters({
        minMeanToMedian: 2,
    ...
    superBonusFeature: {
      ...
      scaling: new OptimizationScaling([
        { criteria: "superfreespins", scaleFactor: 2.8, winRange: [100, 200], probability: 1 },
    ...
    mysteryBonusFeature: {
      ...
      scaling: new OptimizationScaling([
        ...
        { criteria: "superfreespins", scaleFactor: 1.6, winRange: [500, 1000], probability: 1 },
        { criteria: "superfreespins", scaleFactor: 0.35, winRange: [1000, 2000], probability: 1 },
        { criteria: "superfreespins", scaleFactor: 0.04, winRange: [2000, 5000], probability: 1 },
        ...
        { criteria: "hiddenfreespins", scaleFactor: 8.0, winRange: [500, 1000], probability: 1 },
        { criteria: "hiddenfreespins", scaleFactor: 5.0, winRange: [1000, 2000], probability: 1 },
        { criteria: "hiddenfreespins", scaleFactor: 0.01, winRange: [2000, 5000], probability: 1 },
        { criteria: "hiddenfreespins", scaleFactor: 0.0002, winRange: [5000, 10000], probability: 1 },
        { criteria: "hiddenfreespins", scaleFactor: 0.00005, winRange: [10000, 15000], probability: 1 },
        { criteria: "hiddenfreespins", scaleFactor: 1, winRange: [15000, 15000], probability: 1 },
      ]),
      parameters: new OptimizationParameters({
        minMeanToMedian: 2,
    ...
    featureSpin: {
      ...
      scaling: new OptimizationScaling([
        ...
        { criteria: "basegame", scaleFactor: 1.4, winRange: [50, 100], probability: 1 },
        { criteria: "freespins", scaleFactor: 0.25, winRange: [0.01, 1], probability: 1 },
        { criteria: "freespins", scaleFactor: 0.25, winRange: [1, 2], probability: 1 },
        { criteria: "freespins", scaleFactor: 0.12, winRange: [2, 5], probability: 1 },
        { criteria: "freespins", scaleFactor: 0.2, winRange: [5, 10], probability: 1 },
        { criteria: "freespins", scaleFactor: 0.35, winRange: [10, 20], probability: 1 },
        { criteria: "freespins", scaleFactor: 7.0, winRange: [20, 50], probability: 1 },
        { criteria: "freespins", scaleFactor: 3.0, winRange: [50, 100], probability: 1 },
        { criteria: "freespins", scaleFactor: 1.0, winRange: [100, 200], probability: 1 },
        { criteria: "freespins", scaleFactor: 1.6, winRange: [200, 500], probability: 1 },
        { criteria: "freespins", scaleFactor: 0.45, winRange: [500, 1000], probability: 1 },
        { criteria: "freespins", scaleFactor: 0.25, winRange: [1000, 2000], probability: 1 },
        { criteria: "freespins", scaleFactor: 0.15, winRange: [2000, 5000], probability: 1 },
        { criteria: "freespins", scaleFactor: 0.08, winRange: [5000, 10000], probability: 1 },
        { criteria: "freespins", scaleFactor: 0.04, winRange: [10000, 15000], probability: 1 },
        { criteria: "freespins", scaleFactor: 1, winRange: [15000, 15000], probability: 1 },
        ...
        { criteria: "superfreespins", scaleFactor: 3.2, winRange: [50, 100], probability: 1 },
        { criteria: "superfreespins", scaleFactor: 1.0, winRange: [100, 150], probability: 1 },
        { criteria: "superfreespins", scaleFactor: 1.0, winRange: [150, 250], probability: 1 },
        { criteria: "superfreespins", scaleFactor: 2.5, winRange: [250, 500], probability: 1 },
        ...
        { criteria: "superfreespins", scaleFactor: 0.15, winRange: [5000, 10000], probability: 1 },
        { criteria: "superfreespins", scaleFactor: 0.008, winRange: [10000, 15000], probability: 1 },
        { criteria: "superfreespins", scaleFactor: 1, winRange: [15000, 15000], probability: 1 },
        { criteria: "hiddenfreespins", scaleFactor: 0.3, winRange: [0.01, 50], probability: 1 },
        ...
        { criteria: "hiddenfreespins", scaleFactor: 2.5, winRange: [400, 700], probability: 1 },
        { criteria: "hiddenfreespins", scaleFactor: 1.8, winRange: [700, 1500], probability: 1 },
        { criteria: "hiddenfreespins", scaleFactor: 0.9, winRange: [1500, 2500], probability: 1 },
        { criteria: "hiddenfreespins", scaleFactor: 1.2, winRange: [2500, 5000], probability: 1 },
        { criteria: "hiddenfreespins", scaleFactor: 2.5, winRange: [5000, 10000], probability: 1 },
        { criteria: "hiddenfreespins", scaleFactor: 0.15, winRange: [10000, 15000], probability: 1 },
        { criteria: "hiddenfreespins", scaleFactor: 1, winRange: [15000, 15000], probability: 1 },
      ]),
      parameters: new OptimizationParameters({
        minMeanToMedian: 4,
