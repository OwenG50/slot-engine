  ...
  gameModes: {
    base: {
      ...
      scaling: new OptimizationScaling([
        ...
        { criteria: "freespins", scaleFactor: 0.8, winRange: [0.01, 20], probability: 1 },
        { criteria: "freespins", scaleFactor: 1.2, winRange: [20, 50], probability: 1 },
        { criteria: "freespins", scaleFactor: 1.6, winRange: [50, 100], probability: 1 },
        { criteria: "freespins", scaleFactor: 0.75, winRange: [100, 200], probability: 1 },
        { criteria: "freespins", scaleFactor: 0.8, winRange: [200, 500], probability: 1 },
        ...
        { criteria: "superfreespins", scaleFactor: 1.1, winRange: [20, 50], probability: 1 },
        { criteria: "superfreespins", scaleFactor: 1.6, winRange: [50, 100], probability: 1 },
        { criteria: "superfreespins", scaleFactor: 0.9, winRange: [100, 200], probability: 1 },
        { criteria: "superfreespins", scaleFactor: 0.9, winRange: [200, 500], probability: 1 },
        ...
        { criteria: "hiddenfreespins", scaleFactor: 0.85, winRange: [100, 200], probability: 1 },
        { criteria: "hiddenfreespins", scaleFactor: 1.25, winRange: [200, 500], probability: 1 },
        { criteria: "hiddenfreespins", scaleFactor: 2.4, winRange: [500, 1000], probability: 1 },
        { criteria: "hiddenfreespins", scaleFactor: 1.7, winRange: [1000, 2000], probability: 1 },
